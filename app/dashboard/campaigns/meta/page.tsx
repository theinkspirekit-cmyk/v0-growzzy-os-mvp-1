...
export default function MetaAdsPage() {
  ...
  const fetchCampaigns = async () => {
    try {
      setLoading(true)
      const response = await fetch(`/api/campaigns?platform=meta&timeRange=${timeRange}`)
      if (response.ok) {
        const data = await response.json()
      ...
      <div className="p-8 bg-white min-h-screen">
        <div className="max-w-7xl mx-auto">
          <div className="flex justify-between items-center mb-8">
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Meta Ads Campaigns</h1>
            ...
            <div className="space-y-6">
              {campaigns.length === 0 ? (
                <div className="text-center py-16">
                  ...
                  <h3 className="text-xl font-semibold text-gray-900 mb-2">No Meta campaigns found</h3>
                  <p className="text-gray-600 mb-6">Connect your Meta Ads account to start managing campaigns</p>
