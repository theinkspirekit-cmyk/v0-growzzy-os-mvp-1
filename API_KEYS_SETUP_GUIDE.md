...
NEXTAUTH_URL=https://v0-growzzyos.vercel.app
```
...
- Development: `https://v0-growzzyos.vercel.app/api/oauth/meta/callback`
...
META_OAUTH_REDIRECT_URI=https://v0-growzzyos.vercel.app/api/oauth/meta/callback
```
...
4. Create OAuth 2.0 credential (Web Application):
   - Authorized redirect URIs:
     - `https://v0-growzzyos.vercel.app/api/oauth/google/callback`
...
GOOGLE_OAUTH_REDIRECT_URI=https://v0-growzzyos.vercel.app/api/oauth/google/callback
```
...
3. In Auth → Authorized redirect URLs:
   - `https://v0-growzzyos.vercel.app/api/oauth/linkedin/callback`
...
LINKEDIN_OAUTH_REDIRECT_URI=https://v0-growzzyos.vercel.app/api/oauth/linkedin/callback
```
...
SHOPIFY_OAUTH_REDIRECT_URI=https://v0-growzzyos.vercel.app/api/oauth/shopify/callback
```
...
Visit:
- Sign Up: https://v0-growzzyos.vercel.app/auth/signup
- Sign In: https://v0-growzzyos.vercel.app/auth/signin
- Dashboard: https://v0-growzzyos.vercel.app/dashboard (after login)
